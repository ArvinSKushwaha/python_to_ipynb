# Script to IPython Notebooks

This utility converts scripts like the following:
...
![IPython Notebook conversion in
JupyterLab](./assets/monte_carlo_ipynb_readme_demo.png)
